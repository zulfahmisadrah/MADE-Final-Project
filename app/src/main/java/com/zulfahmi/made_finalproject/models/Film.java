package com.zulfahmi.made_finalproject.models;
...
public class Film implements Parcelable {
    ...
    public static Film fromContentValues(ContentValues values) {
        ...
        film.setId(values.getAsInteger("id"));
        film.setTitle(values.getAsString("name"));
        film.setPosterPath(values.getAsString("poster_path"));
        film.setOverview(values.getAsString("overview"));
        film.setDate(values.getAsString("release_date"));
        film.setVoteAverage(values.getAsFloat("vote_average"));
        film.setBackdropPath(values.getAsString("backdrop_path"));
        return film;
    }
